...
class SpeakerDialog extends StatelessWidget {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  "${_homeController.course['kurses'][0]['spicker_name']}",
                                  maxLines: 1,
  ...
  getDesc() {
    var text = "";
    _homeController.course['kurses'][0]['spicker_desc']
        .split("&laquo;")
        .forEach((el) => text += el);
    var text2 = "";
    text.split("&raquo;").forEach((el) => text2 += el);
    var result = "";
    text2.split("&nbsp;").forEach((el) => result += el);
    return result;
  }
}
