                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("${jsonDecode(el)['title']}",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500,color:Colors.black,fontFamily: "Raleway"),),
                                    SizedBox(height: 4,),
                                    Text("Загружено: ${box.read("${jsonDecode(el)['id']}").split("||").length} урока",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color:Color(0xff6A6A6A),fontFamily: "Raleway")),
