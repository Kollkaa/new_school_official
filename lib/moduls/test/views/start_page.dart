            ...
            children: [
                    ...
                    Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: NetworkImage(testController
                                          .homeController
                                          .course['kurses'][0]['banner_big']))),
                            ),
                            SizedBox(
                              height: 13,
                            ),
                            Text(
                                "${testController.homeController.course['kurses'][0]['topic']}",
                            ...
                            Text(
                                "Чтобы сдать тест, нужно ответить на ${testController.stat.data['test_result'][0]['answers_to_pass']} из ${testController.test.data['questions'].length} вопросов",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 14,
              ...
              Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () async {
                      testController.randomizer();
                      await Backend().startTest(
                          id: testController.mainController.profile['id'],
                          course_id: testController
                              .homeController.course['kurses'][0]['id']);
