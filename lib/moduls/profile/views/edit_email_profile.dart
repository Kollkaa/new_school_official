...
class EditEmailProfile extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return StateEmailEdit();
  }

}
class StateEmailEdit extends State<EditEmailProfile>{
