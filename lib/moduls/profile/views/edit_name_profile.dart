                        ...
                        children: [
                          ClipOval(
                              child: _image != null
                                  ...
                                  : _mainController.profile['avatar'] != null
                                      ? Image.network(
  ...
  Widget makeButton() {
    return Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async {
            var response = await Backend().editNameSurname(
                box.read("id"),
                _mainController.nameEditingController.text,
                _mainController.lastnameEditingController.text);
